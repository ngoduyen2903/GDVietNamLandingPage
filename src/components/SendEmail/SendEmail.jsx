        ...
        <div className="row align-items-center" style={{ height: 250 }}>
          <div className="col-12 col-md-6">
            ...
            <div className="position-relative w-100 mt-3">
              ...
              <button type="button" className="btn shadow-none position-absolute top-0 end-0 mt-0 me-2 "><BsSendFill className="fs-5 mb-2" style={{ color: '#00509d', fontSize: 16 }} /></button>
            </div>
          </div>
          <div className="col-md-6 text-center mb-n5 d-none d-md-block"><img className="img-fluid mt-5" src={NewLetter} alt="" style={{ height: 250 }} /></div>
        </div>
      </div>
    </div>
  );
